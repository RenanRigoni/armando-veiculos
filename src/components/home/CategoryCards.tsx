    ...
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
      {categories.map((item) => (
        <Link
          ...
          className="group border-border bg-surface relative flex aspect-[4/5] flex-col justify-end overflow-hidden rounded-md border sm:aspect-[3/4]"
        >
          <Image
            src={item.image}
          ...
          <div className="relative z-10 p-5">
            {item.count > 0 ? (
              <p className="text-brand mb-2 text-xs tracking-widest uppercase">
            ...
            <span className="font-display text-fg group-hover:text-brand mt-4 inline-flex items-center gap-1.5 text-sm tracking-wide uppercase transition-colors">
              Ver estoque
