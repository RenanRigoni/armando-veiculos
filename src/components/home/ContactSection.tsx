    ...
    <Section id="contato" tone="surface">
      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        {business.mapsEmbedUrl ? (
          ...
          // TODO(dono): substituir por embed real assim que a URL do Google Maps chegar.
          <div className="border-border bg-ink flex aspect-[4/3] flex-col items-center justify-center gap-3 rounded-md border">
            <MapPin size={40} className="text-fg-muted/50" aria-hidden />
            <p className="text-fg-muted max-w-xs text-center text-sm">{formatFullAddress()}</p>
          </div>
        )}
      </div>
    </Section>
